...
function setBc(v,p){
  const L={home:'Dashboard',solar:'☀️ Solar',wtg:'🌬️ WTG',zp:'🏬 Zero Point',land:'🌍 Land',landwtg:'📍 WTG Land',landsol:'🌾 Solar Land',bop:'⚙️ BOP','bop-33kv':'33kV','bop-66kv':'66kV','bop-pss':'PSS','bop-gss':'GSS',pod:'📋 POD',safety:'🦺 Safety',manpower:'👷 Manpower',map:'🗺️ Map',itc:'ITC Detail',procurement:'🛒 Procurement',vendors:'🏢 Vendors',inventory:'📦 Inventory',planning:'🗓️ Planning',documents:'🗂️ Documents',reports:'📈 Reports',audit:'🧾 Audit Log'};
...
function rndr(v,p){
  const m={home:rndrHome,solar:rndrSolar,itc:()=>rndrITC(p.itc||curITC),wtg:()=>{rndrWtg();wTab(curWT);},zp:rndrZp,land:rndrLand,landwtg:rndrWtgLand,landsol:rndrSolLand,bop:rndrBop,pod:rndrPod,safety:rndrSafety,manpower:rndrMp,map:rndrMap,procurement:rndrProcurement,vendors:rndrVendors,inventory:rndrInventory,planning:rndrPlanning,documents:rndrDocuments,reports:rndrReports,audit:rndrAudit};
