...
(function (global) {
  ...
  async function updateTurbine(turbId, patch) {
    ...
    const allowed = ['status','lp','pp','civil','mech','uss','sup','notes','mechDates','acts','siteIssues','pathways'];
    const updates = {};
